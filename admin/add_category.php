...
<html>
   	...
   	<body>
   	     <nav class="nav nav-pills flex-column flex-sm-row">
  				<a class="flex-sm-fill text-sm-center nav-link active" href="view_menu.php">Atras</a>
		  </nav>
		   <h2> Agregar Nueva Categoria</h2>
   		<form enctype="multipart/form-data" method="post" action="#">
			<div class="form-group">
				<label>Nombre Categoria</label>
				<input type="text" class="form-control" id="exampleInputEmail1" name="categoria" placeholder="Nombre categoria" required />
			</div>   
		   ...
		   <div class="input-group mb-3">
   			...
   			<button style="margin-left: 45%;" class="btn btn-primary" name="submit">Agregar Categoria</button>
   		</form>
   	</body>
</html>