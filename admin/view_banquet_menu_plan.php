...
<html>
    ...
    <title>Plan de menús para banquetes </title>
    ...
    <nav class="nav nav-pills flex-column flex-sm-row">
          ...
          <a class="flex-sm-fill text-sm-center nav-link" href="add_banquet_menu_plan.php">Agregae Plan</a>
    </nav>
        
        <h2>Plan de menús para banquetes </h2>
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td><a href="update_banquet_menu_plan.php?id=<?php echo $r['id']; ?>"> Actualizar </a></td>
                </tr>
                <?php
