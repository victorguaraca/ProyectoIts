...
<body>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="heading-title text-center">
                    <h2 style="color:#b13476">Tu Opinión es Valiosa Para Nosotros</h2>
                    <p>Por favor, toma un minuto para darnos tu opinión.</p>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12 p-2">
                            <div class="form-group">
                                <span class="field-title" style="font-size:26px"> Tu Nombre (opcional) </span>
                        ...
                        <div class="col-md-12 p-2">
                            <div class="form-group">
                                <span class="field-title" style="font-size:26px"> ¿Qué tan satisfecho estás con nuestros servicios? </span>
                        ...
                        <div class="col-md-12 p-2">
                            <div class="form-group">
                                <span class="field-title" style="font-size:26px"> Tu Reseña para Yajman Restaurant & Banquet</span>
                                <textarea class="form-control" id="message" placeholder="Tu Reseña" name="comment" rows="4"></textarea>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="submit-button text-center">
                                <button class="btn btn-common" id="submit" type="submit" name="submit">Enviar</button>
		...
		<div class="row">
			<div class="col-lg-4 col-md-6">
				...
				<p>
					...
					<span style="padding:8px">'J The Vision' Grupo</span>
				</p>
				<ul style="padding:10px">
					<li style="color:white"> Restaurante </li>
					<li style="color:white"> Salón de banquetes </li>
					<li style="color:white"> Reserva de salón de bodas </li>
					<li style="color:white"> Arquitecto y diseño de hogar </li>
				</div>
			<div class="col-lg-4 col-md-6">
				<h3>Información de contacto</h3>
				<p class="lead">Restaurante Yajman, Dharm Nagar II, Sabarmati, Ahmedabad, Gujarat 380005</p>
			...
			<div class="col-lg-4 col-md-6">
				...
				<p><span class="text-color">Horario del salón de banquetes:</span> 8 AM a 11 PM</p>
				<p><span class="text-color">Restaurante (Para llevar):</span> 10:30 AM - 3:30 PM, 7 PM - 11 PM</p>
			</div>
		</div>
	</div>
	...
	<div class="copyright">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<p class="company-name">Derechos Reservados. &copy; 2020 <a href="./index.html">&nbsp;Restaurante y Salón de Banquetes Yajman</a> <br>Administrado por 'J The Vision' Grupo</p>
				</div>
			</div>
		</div>
	</div>
