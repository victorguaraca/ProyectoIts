...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>JDV Restaurant y  Banquetes</title>
        ...
        <div class="main-section-categ">
            <div class="main-section-container">
                <div class="heading-title text-center">
                    <h1 style="margin-bottom:0px; font-size: 32px; color: #b13476">Confirmar Orden</h1>
										<p>Rellene los siguientes datos para reservar el pedido.er.</p>
				</div>
            </div>
        </div>
    </section>
        				...
        				<div class="row">
        					<div class="col-lg-12">
        						<form id="contactForm" method="post" action="#">
        							<div class="row">
        								<div class="col-md-12">
        									<span class="field-title" > Introduzca el nombre : </span>
        								...
        								<div class="col-md-12">
        									<span class="field-title"> Introduzca Email-id : </span>
        									<div class="form-group">
        								...
        								<div class="col-md-12">
        									<span class="field-title"> Introduzca el numero de telefono: </span>
        									<div class="form-group">
        								...
        								<div class="col-md-12">
        									<span class="field-title"> Introdusca detalles de direccion : </span>
        									<div class="form-group">
                                        ...
                                        <div class="col-md-12">
        									<span class="field-title"> Hora de recogida : </span>
        									<div class="form-group">
                                        ...
                                        <div class="col-md-12">
        									<span class="field-title"> Factura total (impuestos incluidos): </span>
        									<div class="form-group">
