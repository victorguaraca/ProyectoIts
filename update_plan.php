<?php
    ...
    $exec = mysqli_query($con,"select * from banquet_plans where id_planBan = $id");
    ...
    <title>Update Banquet Plan</title>
        ...
        <body>
            <nav class="nav nav-pills flex-column flex-sm-row">
  				<a class="flex-sm-fill text-sm-center nav-link active" href="/admin_display_plan.php">Regresar</a>
  				<a class="flex-sm-fill text-sm-center nav-link" href="/admin_plan.html">Añadir plan</a>
		  </nav>
            <h2> Plan de actualización de Detalle</h2>
            <form method="post" action="#" enctype="multipart/form-data">
                ...
                <button style="margin-left:40%;" type="submit" name="update" value="Update Plan"  class="btn btn-primary"> Plan de actualización </button>
                <?php   
                                    }
                }
                ?>
