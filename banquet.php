...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>JDV Restaurante and Banquetes</title>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="pagina2.php">Llevar</a></li>
						<li class="nav-item active"><a class="nav-link" href="banquet.php">Banquetes</a></li>
					...
					<div class="col-lg-12">
						<form id="contactForm" method="post" action="banquet-1.php">
							<div class="row">
                                <div class="col-md-12">
									...
									<div class="form-group">
										<select class="custom-select d-block form-control" id="n-reason" required data-error="Please Select No. of Slots" name="menu">
											...
											<option value="250">Plan - 1 : 250/- por plato</option>
											<option value="300">Plan - 2 : 350/- por plato</option>
											<option value="350">Plan - 3 : 450/- por plato</option>
											<option value="450">Plan - 4 : 550/- por plato</option>
											<option value="550">Plan - 5 : 650/- por plato</option>
										</select>
										<div class="help-block with-errors"></div>									
									</div>
                                </div>
								<div class="col-md-12">
									<span class="field-title" > Introduzca el número de personas </span>
									<div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <span class="field-title">Factura total de alimentos</span>
                                    <div class="form-group">
