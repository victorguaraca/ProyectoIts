			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active"><a class="nav-link" href="takeaway.php">Pedido</a></li>
		...
		<div class="row">
			<div class="col-12">
			    ...
			    <a href="pedido.php"><i class="fa fa-utensils icon1" style="color: #b13476; border: 2px solid #b13476"></i></a>
					<a href="pedido-1.php"><i class="fa fa-cart-plus icon1" style="color: #b13476; border: 2px solid #b13476"></i></a>
...
?>
        ...
        <div class="main-section-categ">
            <div class="main-section-container">
                <div class="heading-title text-center">
                    <h1 style="margin-bottom:0px; font-size: 32px; color: #b13476">Pida su plato favorito</h1>
										<p>Elija el plato de comida sabrosa que prefiera.</p>
				</div>
				<!-- Choose Category-->
				<div class="menu">
				    <div class="category">
				        <?php 
        			        $exe = mysqli_query($con,"select * from categoria order by Nombre");
        			        while($r1 = mysqli_fetch_array($exe) ){
        				?>
        				<div class="categItem">
        		           	<a class="btn btn-lg btn-circle btn-outline-new-white" style="font-size:14px; padding:10px; border-radius:8px;" href="pedido-1.php?id_categoria=<?php echo $r1['id_categoria']; ?>"><?php echo $r1['Nombre']; ?></a>
        				</div>
        				<?php } ?>
				    </div>
                    ...
                    <div class="items">
                        <div class="itemsMenu">
                                <?php   
                                    $exec = mysqli_query($con,"select * from menu where tipo = $cid AND Mostrar_parallevar = 'YES' order by prioridad");
                                    while($r = mysqli_fetch_array($exec)){     
                                ?>
                                <div class="mainItem">
        		                    <form method="post" class="mainItem" action="pedido-1.php?action=add&id=<?php echo $r['mid']; ?>">
                                        <span class="itemName"><?php echo $r['Nombrem'];  ?></span>
                                        <span class="verticalDevider">|</span>
                                        <span class="itemPrice">Precio. <?php echo $r['precio']; ?></span>
                                        <span class="verticalDevider">|</span>
 ...
 <!-- Retieve Menu Details & Cart -->
			...
			if (isset($_POST["add"])){
                ...
                if (isset($_SESSION["cart"])){
					...
					if (!in_array($_GET["id"],$item_array_id)){
						...
						echo '<script>alert("Producto ya agregado en el carro ")</script>';
					}
				}else{
					$i_array = array(
						'product_id' => $_GET["id"],
				...
				if ($_GET["action"] == "delete"){
					foreach ($_SESSION["cart"] as $keys => $value){
						if ($value["product_id"] == $_GET["id"]){
							...
							echo '<script>alert("El producto se a removido...!")</script>';
							echo '<script>window.location="pedido-1.php"</script>';
						}
					}
				}
				if(isset($_SESSION['cart'])){
	...
	?>
	    <form method="post" action="pedido-2.php">
	        <div class="col-md-12">
		 ...
		 <form method = "post" action="pedido-2.php">
            ...
            <div class="table-responsive">
                ...
                <tr>
                    ...
                    <th width="13%">Precios</th>
                    <th width="10%">Precio total</th>
                    <th width="17%">Quitar artículo</th>
                </tr>
                    ...
                    if(!empty($_SESSION["cart"])){
                        ...
                        foreach ($_SESSION["cart"] as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td><a href="pedido-1.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
                            ...
                            <tr>
                                <td colspan="2"></td>
                                <td ><b>Total (impuestos incluidos)</b></td>
			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<div class="overflow-hidden">
						<h4>Location</h4>
						<p class="lead">
							JDV Restaurant, Dharm Nagar II, Sabarmati, Ahmedabad.
						</p>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4 col-md-6">
					...
					<span style="padding:8px">'JDV The Vision' Group </span>
					</p>
